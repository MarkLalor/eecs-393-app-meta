...
\begin{itemize}
	...
	\item SE-2: Only the administrators of CCA will have direct access to the Course Resource System and Student Information System databases.
	\item SE-3: Users will only be able to view public class conversations, conversations they previously created, or conversations they have been invited to
	\item SE-4: Only users who have logged in will be allowed to upload documents to the system
\end{itemize}
